...
if __name__ == "__main__":
    ...
    suffix_raw  = pd.read_csv('ieren.csv', sep = ",")       # this file contains a line for each -nis attestation in the corpus, together with the respective decade and filename
    ...
    # save dataframe
    pneo_global.to_csv("IEREN_pneo_global_100000.csv", encoding = "utf-8")
    tokens_global.to_csv("IEREN_tokens_global_100000.csv", encoding = "utf-8")
    hapax_global.to_csv("IEREN_hapax_global_100000.csv", encoding = "utf-8")
    hapax_and_new_global.to_csv("IEREN_hapax_and_new_global_100000.csv", encoding = "utf-8")
    vneo_global.to_csv("IEREN_vneo_global_100000.csv", encoding = "utf-8")
    types_global.to_csv("IEREN_types_global_100000.csv", encoding = "utf-8")
