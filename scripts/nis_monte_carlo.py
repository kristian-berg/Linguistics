# Monte Carlo simulation for the German word formation pattern -nis
...
if __name__ == "__main__":
    ...
    suffix_raw  = pd.read_csv('nis.csv', sep = ",")       # this file contains a line for each -nis attestation in the corpus, together with the respective decade and filename
    ...
    # save dataframe
    pneo_global.to_csv("NIS_pneo_global_100000.csv", encoding = "utf-8")
    tokens_global.to_csv("NIS_tokens_global_100000.csv", encoding = "utf-8")
    hapax_global.to_csv("NIS_hapax_global_100000.csv", encoding = "utf-8")
    hapax_and_new_global.to_csv("NIS_hapax_and_new_global_100000.csv", encoding = "utf-8")
    vneo_global.to_csv("NIS_vneo_global_100000.csv", encoding = "utf-8")
    types_global.to_csv("NIS_types_global_100000.csv", encoding = "utf-8")
