...
types_tum = pd.read_csv("TUM_types_global_100000.csv", sep = ",", index_col = 0)
tokens_tum = pd.read_csv("TUM_tokens_global_100000.csv", sep = ",", index_col = 0)
