# This script produces plot 9 in the Linguistics paper.
...
types_tum = pd.read_csv("NIS_types_global_100000.csv", sep = ",", index_col = 0)
tokens_tum = pd.read_csv("NIS_tokens_global_100000.csv", sep = ",", index_col = 0)
...
figure_env(ax2, "# -nis tokens")
ax2.set_ylim(0,8000)



fig.tight_layout(pad = 2)
fig.savefig('plot_9_Linguistics.png', dpi=800)
